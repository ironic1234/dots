...
- Produce phased plans with explicit tasks and acceptance criteria.
- Define test strategy handoff for `test-runner`.
...
- S2 Plan: Produce ordered phases and task list.
...
Output Contract:
- Include: phased plan, assumptions, risks, acceptance criteria, and test strategy handoff.
